...
if (cluster.isMaster) {
    ...
    console.log(`FLOODER TO ALL SERVER !!!`);
    ...
    if (debugMode) {
        setInterval(() => {
            ...
            for (let [code, count] of sortedStatuses) {
                ...
                let coloredCode;
                if (code === 'GOAWAY') {
                    coloredCode = `|${code.padEnd(14)}`.magenta;
                } else if (code.startsWith('2')) {
                    coloredCode = `|${code.padEnd(14)}`.green;
                } else if (code.startsWith('4')) {
                    coloredCode = `|${code.padEnd(14)}`.yellow;
                } else if (code.startsWith('5')) {
                    coloredCode = `|${code.padEnd(14)}`.red;
                } else {
                    coloredCode = `|${code.padEnd(14)}`.gray;
                }
